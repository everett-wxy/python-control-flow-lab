...
def check_voting_eligibility():
    user_input = int(input('Please enter your age: ').strip())
    voting_age = 18
    if user_input < 0:
        print("age can't be negative")
    elif user_input <= voting_age:
        print ('too young to vote')
    else:
        print(f"You are {user_input} years old and is eligible to vote.")
...
def calculate_dog_years():
    user_input = input("Input a dog's age: ").strip()
...
def weather_advice():
    is_cold = input("Is it cold? (y/n): ").strip().lower()
    is_raining = input("Is it raining? (y/n): ").strip().lower()

    if is_cold == "y" and is_raining == "y":
        print("wear a waterproof coat.")
    elif is_cold == "y" and is_raining == "n":
        print("wear a warm coat.")
    elif is_cold == "n" and is_raining == "y":
        print("carry an umbrella.")
    elif is_cold == "n" and is_raining == "n":
...
def determine_season():
    try:
        ...
        if month not in ("Jan", "Feb", "Mar", "Apr", "May", "Jun", 
            ...
            print("Only accepts three-character month abbreviation.")
            return
        if day < 1 or day > 31:
        ...
        print("Invalid input. Please enter the day as a number.")
